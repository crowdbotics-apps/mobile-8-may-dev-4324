"""mobile_8_may_dev_4324 URL Configuration
...
admin.site.site_header = "mobile 8 may"
admin.site.site_title = "mobile 8 may Admin Portal"
admin.site.index_title = "mobile 8 may Admin"

# swagger
schema_view = get_schema_view(
    openapi.Info(
        title="mobile 8 may API",
        default_version="v1",
        description="API documentation for mobile 8 may App",
    ),
    public=True,
